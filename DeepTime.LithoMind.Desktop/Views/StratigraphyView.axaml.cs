...
namespace DeepTime.LithoMind.Desktop.Views
{
	...
	/// 地层对比视图代码后置
	/// </summary>
	public partial class StratigraphyView : UserControl
	{
		private bool _isPanning = false;
		private Point _lastPanPosition;

		public StratigraphyView()
		{
			InitializeComponent();
		...
		{
			if (DataContext is StratigraphyViewModel vm)
			{
				// 滚轮缩放
		...
		{
			if (_isPanning && DataContext is StratigraphyViewModel vm)
			{
