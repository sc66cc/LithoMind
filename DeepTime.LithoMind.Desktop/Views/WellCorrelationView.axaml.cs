...
namespace DeepTime.LithoMind.Desktop.Views
{
	...
	/// 联井剖面图视图代码后置
	/// </summary>
	public partial class WellCorrelationView : UserControl
	{
		private bool _isPanning = false;
		private Point _lastPanPosition;

		public WellCorrelationView()
		{
			InitializeComponent();
		...
		{
			if (DataContext is WellCorrelationViewModel vm)
			{
				// 滚轮缩放（不需要Ctrl键）
		...
		{
			if (_isPanning && DataContext is WellCorrelationViewModel vm)
			{
